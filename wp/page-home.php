            ...
            <div id="slide">
                <ul>
                    ...
                    <?php while(have_rows('mv_slide_repeat')): the_row(); ?>
                        <li>
                            <div class="hidden-xs slide_img" style="background-image: url(<?php the_sub_field('img_mv_pc'); ?>);background-size: cover;"></div>
                            <div class="visible-xs slide_img" style="background-image: url(<?php the_sub_field('img_mv_sp'); ?>);background-size: cover;"></div>
                        </li>
                    <?php endwhile; ?>
                    <?php endif; ?>
                </ul>
